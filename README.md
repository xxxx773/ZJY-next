...
>ZJY Next 是一个面向职教云学习场景的效率工具，涵盖账号绑定与多账号管理、课程和课件查看、学习进度同步、普通/手势/扫码签到、作业与考试信息查看、题库归档、AI 学习辅助，以及资源、公告和反馈管理。用户可在同一工作台完成课程信息查看、任务跟进与学习记录管理。

##  浏览器在线访问

> 项目地址：[https://.top/](https://.top/)　｜　如需提升账号权限，请在网站界面进行问题反馈。
...
![ZJY Next 学习辅助流程](assets/learning-assistance-flow.svg)
